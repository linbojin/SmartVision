...
namespace IPCamera
{
    //ToolStripRadioButtonMenuItem类，用于生成菜单单选效果。
    //只要把子菜单项创建为ToolStripRadioButtonMenuItem类，把Designer里面
    //System.Windows.Forms.ToolStripMenuItem改为ToolStripRadioButtonMenuItem即可。
